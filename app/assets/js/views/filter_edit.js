...
App.views.CategoriesFilterEdit = Backbone.View.extend({
  ...
  initialize: function() {
    ...
    this.categories.bind('fetch', this.render);
  ...
  render: function() {
    ...
    this.categories.visible().each(function(category) {
  ...
  clearAll: function() {
    ...
    $('#categories_filter_edit span.selected').html('<a href="#"><span class="count">0</span> selected</a>')
  }
});
