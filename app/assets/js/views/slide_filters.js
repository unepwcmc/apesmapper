...
App.views.SlideFilters = Backbone.View.extend({
  ...
  update_sliders_bounds: function(){
    ...
    $(".range-form .biodiversity .min-value").val(this.species_ials.roundDown2dp(minBiodiversity));
    $(".range-form .biodiversity .max-value").val(this.species_ials.roundUp2dp(maxBiodiversity));
  ...
  stop_slider: function(event, ui) {
    if(jQuery(event.target).parents('.range').hasClass("response")) {
      ...
      $(".range-form .biodiversity .min-value").val(this.species_ials.roundDown2dp(ui.values[0]));
      $(".range-form .biodiversity .max-value").val(this.species_ials.roundUp2dp(ui.values[1]));
