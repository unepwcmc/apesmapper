   ...
   var Router = Backbone.Router.extend({
    ...
    app.Carbon = Class.extend({
        ...
        run: function() {
            ...
            this.selectedFiltersView = new App.views.SelectedFilters({bus:this.bus, apes: this.apes.allApes, countries: this.countries.allCountries, sites: this.sites.allSites});
